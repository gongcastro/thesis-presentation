...
:::
::: {.column width="40%"}
![](assets/img/hoff-1.png){width="80%"}
![](assets/img/hoff-2.png){width="80%"}
...
1. Provide a mechanistic account for the cognateness facilitation in early word acquisition
...
## Extending the model to the **bilingual** case:
...
* 436 questionnaire administrations (366 children)
* Aged 12-32 months (*M* = 22.2, *SD* = 4.9, *Range* = 12.1–31.9)
...
![@mani2010infant](assets/img/mani-1.png)

::::

:::: {.column width="40%"}

![@mani2010infant](assets/img/mani-2.png){width="40%"}
