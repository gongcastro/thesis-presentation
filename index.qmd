...
1. **Study 1**: AMBLA model, acquisition of cognates, role of language exposure3
2. **Study 2**: language non-selectivity in the initial bilingual lexicon
3. **Discussion**
...
- Vocabulary size [@braginsky2019consistency]
- Semantic and phonological associations [@fourtassi2020growth]
- Efficiency in lexical access [@marchman2008speed]

![](assets/img/development.jpg)
...
![@bergelson2012months, *Science News*](assets/img/bergelson.jpg){width="80%"}
...
![@fenson1994variability](assets/img/macarthur.jpg){width="80%"}
...
**Cascaded activation**: activation spreads across non-selected lexical representations
...
![@allopenna1998tracking](assets/img/allopenna-2.png){width="30%"}
...
- Semantic priming [@styles2009how; @arias-trejo2009lexical]
- Phonological priming [@mani2010infant; @avila-varela2021longitudinal]

![](assets/img/chow.jpg){width="80%"}
...
Yet, **bilinguals keep up with monolinguals** [@sebastian-galles2020bilingual]
...
English-Spanish bilinguals in Florida
...
Lexical similarity: average Levenshtein similarity between translations equivalents (TE)

::: box

**Cognate**: form-similar TE
...
* **Barcelona Vocabulary Questionnaire (BVQ)**: vocabulary checklist, language exposure questionnaire, demographic survey
    - Online, inspired by Oxford CDI [@hamilton2000infant]
    - 793 Catalan words, 797 Spanish words, divided into 4 sublists

* *N* = 366 children, 12-32 months (*M* = 22.23, *SD* = 4.88, *Range* = 12.06–31.93)
* Exposed to Catalan and Spanish (+ up to 10% to a 3rd languages)

## Methods

* 302 translation equivalents
* 234 questionnaire administrations
...
## Results: fixed regression coefficients
...
## Results: marginal posterior predictions
...
## Language non-seletivity in the initial lexicon

Cross-language phonological priming:

@vonholzen2012language: German-English (*N* = 20, 21-43 months), priming through translation paradigm

## Language non-seletivity in the initial lexicon

@mani2010infant: English monolinguals, implicit priming
