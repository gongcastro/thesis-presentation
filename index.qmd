...
\text{Learning instances}_{ij} &= \text{Age}_i \cdot \text{Freq}_j \\
\textbf{where:} \\
...
\textbf{For participant } &i \textbf{ and word-form } j \text{ (translation of } j'): \\
\text{Age of Acquisition}_{ij} &= \{\text{Age}_i \mid \text{Learning instances}_{ij} = c\}\\
\text{Learning instances}_{ij} &= \text{Age}_i \cdot \text{Freq}_j \cdot \color{IBMMagenta}{\text{Exposure}_{ij}} \\
\textbf{where:} \\
\text{Freq}_j &\sim \text{Poisson}(\lambda = 50) \\
c &= 300 \\
\end{aligned}
...
![](assets/img/ambla-eli-single.gif){width="80%"}
...
\textbf{For participant } &i \textbf{ and word-form } j \text{ (translation of } j'): \\
\text{Age of Acquisition}_{ij} &= \{\text{Age}_i \mid \text{Learning instances}_{ij} = c\}\\
\text{Learning instances}_{ij} &= \text{Age}_i \cdot \text{Freq}_j \cdot \color{IBMMagenta}{\text{Exposure}_{ij}} \cdot \color{IBMMagenta}{\text{Cognateness}_{j}}\\
\textbf{where:} \\
\text{Frequency}_j &\sim \text{Poisson}(\lambda = 50) \\
c &= 300 \\
\color{IBMMagenta}{\text{Cognateness}_{j}} = &\color{IBMMagenta}{\text{Levenshtein}(j, j')}
\end{aligned} \\
$$
:::
